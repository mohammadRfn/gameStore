<template>
    <AppLayout>
        <div class="gx-page">
            ...
            <LuxHero
                chip="ماژول انبار"
                chip-two="Items / Create"
                title="محصول «جدید»"
                lead="افزودن قلم تازه به انبار — با قیمت‌گذاری، دسته‌بندی و ویژگی‌های سریال و گارانتی."
                cube="📦"
                satellite="✨"
            >
                <template #chip-icon><PackagePlus :size="13" /></template>
                <template #actions>
                    ...
                    <div class="gx-panel__body">
                        ...
                        <div class="gs-input-group">
                            ...
                            <label class="gx-dropzone">
                                ...
                                <ImagePlus :size="18" />
                                <span>{{ form.image ? form.image.name : 'انتخاب تصویر محصول...' }}</span>
                            </label>
                        </div>

                        <!-- پیش‌نمایش -->
                        <div v-if="preview" class="gx-preview">
...
.gx-preview {
    ...
    animation: gx-rise 0.5s var(--gx-ease, ease) both;
}
